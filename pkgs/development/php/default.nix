...
in {
  ...
  php80 = generic {
    version = "8.0.29";
    sha256 = "sha256-k8I43fSJLsIppsjXzJoxmjUSWbwGJX3hkxxKyagz3ME=";
  };

  php81 = generic {
    version = "8.1.21";
    sha256 = "sha256-L01cSJm6afyNkZ3rF4BceasSRhlRAKlADlIXasEZPb0=";
  };

  php82 = generic {
    version = "8.2.4";
    sha256 = "sha256-iFxI7LvPqjciG2rpLymFh02rpoV6t/MkTPrVtPnpvzQ=";
  };
}
