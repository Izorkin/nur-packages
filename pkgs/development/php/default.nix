...
in {
  ...
  php80 = generic {
    version = "8.0.28";
    sha256 = "sha256-YOOaT1rQWivY0JeQGcGWc6uIlXpHcoUmf31mIYstQtw=";
  };

  php81 = generic {
    version = "8.1.17";
    sha256 = "sha256-lb5IOfC+t15KpMFxL4WTL9Q7dvKjG7JBUnBOau70N5w=";
  };

  php82 = generic {
    version = "8.2.3";
    sha256 = "sha256-OE8CBiQ6JYSR20Vplj2OZm2f3Sfr/XCh/aNWKqR443s=";
  };
}
