...
let
  ...
  composer2 = mkDerivation rec {
    ...
    src = pkgs.fetchurl {
      url = "https://getcomposer.org/download/${version}/composer.phar";
      sha256 = "0lprp0rhjlg7zc22cl5z6pnb7p00lgnzr670v8mxhjvzcgaf1vnn";
    };
  ...
  event = buildPecl {
    ...
    sha256 = "1i92kdh9lrjg8sjqd08p6j6zv9xy6f210zk2i9xpc8fpg1l876ay";
  ...
  php-cs-fixer = mkDerivation rec {
    ...
    src = pkgs.fetchurl {
      ...
      sha256 = "1dcaa9nj0555vp0s3n3as8sdljh0d4spc3zjczh4byyxnnzxc2b6";
    };
  ...
  phpstan = mkDerivation rec {
    ...
    src = pkgs.fetchurl {
      ...
      sha256 = "1p6qdycpjhsfxjlgm7yj2m7pgba4vcp0plv84x94iigsihmxhzkx";
    };
  ...
  protobuf315 = buildPecl {
    ...
    sha256 = "0ar6zdk4zp5s6f320n7slrqnjjc27j46fsa435wgyjflglj71alw";
  ...
  psalm = mkDerivation rec {
    ...
    src = pkgs.fetchurl {
      ...
      sha256 = "02xzp0ghq6lwssq7akazjsq94ymx733v6qh63radjs4rcrkip4lw";
    };
