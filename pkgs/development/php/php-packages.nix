...
let
  ...
  psalm = mkDerivation rec {
    ...
    src = pkgs.fetchurl {
      ...
      sha256 = "1p6vcasifl3zpyzzyz54nx5xyqvwi3hpabiw6vc1xs6cimb8k32a";
    };
  ...
  redis50 = buildPecl rec {
    ...
    sha256 = "1rw9xirskbcbkic33mwff87l4xnrkfiga0jlyn368cbz5nfwlkab";
  ...
  #xdebug28 = assert !isPhp56; buildPecl rec {
  xdebug28 = buildPecl rec {
    version = "2.8.0";
    pname = "xdebug";
