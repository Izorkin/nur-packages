...
let
  ...
  xdebug = if isPhp56 then xdebug25 else (if isPhp80 then xdebug32 else (if isPhp72 then xdebug31 else xdebug29));
  ...
  xdebug32 = buildPecl {
    ...
    sha256 = "sha256-9Id3Nx+Qy7MV6k6ggqHt5nZbz7NdfWNWq49x/W38wVc=";
