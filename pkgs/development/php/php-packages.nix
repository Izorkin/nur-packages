...
let
  ...
  mongodb = if isPhp56 then mongodb175 else (if isPhp72 then (if isPhp74 then mongodb117 else mongodb116) else mongodb111);
  ...
  mongodb117 = buildPecl {
    pname = "mongodb";
    version = "1.17.0";

    sha256 = "sha256-Xn25UQPXMhLtDt+Ih9khhLqlZDR2BFy4me+89DmEcUg=";
