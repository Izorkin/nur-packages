...
, libaio, libevent, jemalloc, cracklib, systemd, perl, fmt
...
common = rec { # attributes common to both builds
  ...
  src = fetchurl {
    ...
    sha256 = "sha256-7HDiSh7kIIexGHxzTa1a6LNqTObjY17HYRK9B9gZ1r4=";
  ...
  buildInputs = [
    ncurses openssl zlib pcre2 libiconv curl fmt
