...
rec {
  ...
  curl                = pkgs.callPackage  ./pkgs/tools/curl { openssl = pkgs.libressl; inherit libssh2; idnSupport = true; brotliSupport = true; scpSupport = true; opensslSupport = true; zlibSupport = true; zstdSupport = true; ipv6Support = true; };
