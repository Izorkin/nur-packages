...
rec {
  ...
  curl                = pkgs.callPackage  ./pkgs/tools/curl { openssl = pkgs.libressl; inherit libssh2; http3Support = true; brotliSupport = true; websocketSupport = true; idnSupport = true; pslSupport = true; zstdSupport = true; };
